...
namespace WindowsFormsApp1.TCandCCDataSet2TableAdapters {
    ...
    public partial class tbl_Student_InfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbl_Student_Info] ([EnrollmentNo], [RollNo], [SRNo], [StudentName], [FatherName], [MotherName], [Address], [DoB], [AdmissionDate], [DuesClearedUpto], [DateOfLeaving], [ClassPassed], [Session], [Attendance], [Remark], [StudentPic], [TcCreated], [CCCreated]) VALUES (@EnrollmentNo, @RollNo, @SRNo, @StudentName, @FatherName, @MotherName, @Address, @DoB, @AdmissionDate, @DuesClearedUpto, @DateOfLeaving, @ClassPassed, @Session, @Attendance, @Remark, @StudentPic, @TcCreated, @CCCreated)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EnrollmentNo, RollNo, SRNo, StudentName, FatherName, MotherName, Address, " +
                ...
                "ance, Remark, StudentPic, TcCreated, CCCreated FROM dbo.tbl_Student_Info";
